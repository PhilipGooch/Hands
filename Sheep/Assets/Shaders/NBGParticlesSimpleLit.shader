/*
 * Currently this shader is a slight modification of: "Universal Render Pipeline/Particles/Simple Lit"
 * All modified places are followed by code comment "EDIT by NBG:"
 */
Shader "Universal Render Pipeline/Particles/NBG Simple Lit"
{
    Properties
    {
        ...
        // NBG Custom properties
        [HideInInspector] _ZTest("__zt", Float) = 4.0 // EDIT by NBG: Added ztest parameter
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            ZWrite[_ZWrite]
            ZTest[_ZTest] // EDIT by NBG: Added ztest parameter
            Cull[_Cull]
    ...
    CustomEditor "ParticleNBGSimpleLitShaderEditor" // EDIT by NBG: Swapped out shader editor to the one that contains ztest parameter
}
