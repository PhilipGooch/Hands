...
namespace Valve.VR
{
    public partial class SteamVR_Input
    {
        ...
        public static void PreinitializeActionSetDictionaries()
        {
            ...
            {
                SteamVR_ActionSet actionSet = actionSets[actionSetIndex];
                // BEGIN_NBG_EDIT: Fix steamvr throwing errors about missing key in dictionary due to different action capitalization
                actionSetsByPath.Add(actionSet.fullPath.ToLower(), actionSet);
                // END_NBG_EDIT
