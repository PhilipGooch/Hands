...
{
	internal static class EdgeVertex
	{
		...
		public static float3[] outline  =
		{
			...
			new float3(0f, 1f, 0f), 
			new float3(1f, 1f, 0f), 
			new float3(1f, 0.5044522f, 0f), 
			new float3(0.9955279f, 0.5022361f, 0f), 
		...
		public static float3[] _vertices =
		{
			...
			new float3(1f, 0.5044522f, 0.1f), 
			new float3(0.9955279f, 0.5022361f, 0.1f), 
			new float3(1f, 0.5f, 0.1f), 
