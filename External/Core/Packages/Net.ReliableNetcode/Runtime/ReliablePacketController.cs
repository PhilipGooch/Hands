...
namespace ReliableNetcode
{
    public class ReliableDefines
    {
        ...
        public const int MaxPacketSize = FragmentSize * MaxFragments;
    }
    ...
    internal class ReliableConfig
    {
        ...
        public static ReliableConfig DefaultConfig()
        {
            ...
            config.MaxPacketSize = ReliableDefines.MaxPacketSize;
            config.FragmentThreshold = ReliableDefines.FragmentSize;
            config.MaxFragments = ReliableDefines.MaxFragments;
            config.FragmentSize = ReliableDefines.FragmentSize;
