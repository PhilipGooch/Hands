...
namespace NBG.Core
{
    ...
    public static class DebugExtension
    {
        ...
        public static void DrawAllAxis(Vector3 pos, Quaternion rot)
        {
            Debug.DrawRay(pos, rot * Vector3.forward, Color.blue);
            Debug.DrawRay(pos, rot * Vector3.right, Color.red);
            Debug.DrawRay(pos, rot * Vector3.up, Color.green);
        }
