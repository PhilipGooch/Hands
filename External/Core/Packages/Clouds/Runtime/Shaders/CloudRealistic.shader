...
Shader "FX/Cloud System/CloudRealistic (Alpha Blended)" {
Properties {
...
//				#endif
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				fixed4 col = i.color * _TintColor * texColor;
				half dotProduct = dot(normalize(i.normal), normalize(-_WorldSpaceLightPos0.xyz));
				...
				half cameraDot = saturate(dot(toCamera, normalize(-_WorldSpaceLightPos0.xyz + _SunOffset.xyz)));
