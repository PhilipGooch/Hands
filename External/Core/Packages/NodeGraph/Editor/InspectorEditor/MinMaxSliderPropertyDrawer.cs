...
{
    public class MinMaxSliderPropertyDrawer : NBGPropertyDrawer
    {
        public override void DrawProperty(SerializedProperty property)
        {
            EditorDrawUtility.DrawHeader(property);

            MinMaxSliderAttribute minMaxSliderAttribute = ReflectionUtility.GetAttribute<MinMaxSliderAttribute>(property);
